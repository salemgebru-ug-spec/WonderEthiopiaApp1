...
export default function DestinationDetail() {
  ...
  const handleEditReview = (reviewId: string) => {
    // Add your edit logic/modal opening state here
  ...
  if (!destination) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-background px-6 text-center">
        ...
        <h1 className="text-3xl font-bold tracking-tight mb-2">Destination Not Found</h1>
        <p className="text-muted-foreground max-w-sm mb-8">
          The place you are looking for does not exist or has been permanently moved.
        </p>
        <Link
    ...
    <div className="min-h-screen bg-background text-foreground antialiased selection:bg-primary/10">
      ...
      <main className="max-w-4xl mx-auto px-4 md:px-8 py-12 lg:py-16 space-y-12">
        ...
        <div className="space-y-6">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight">About this destination</h2>
