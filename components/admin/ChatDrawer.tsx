...
export default function ChatDrawer({ isOpen, onClose, businessId, businessName, currentRole }: ChatDrawerProps) {
    ...
    <div className="fixed inset-0 z-[100] flex justify-end">
      ...
      <div className="relative w-full max-w-xl bg-white h-full shadow-[-20px_0_50px_rgba(0,0,0,0.1)] animate-slide-left flex flex-col">
        ...
        <div className="flex-1 overflow-hidden">
          <BusinessChat businessId={businessId} currentRole={currentRole} />
        </div>
      </div>
    </div>
  );
