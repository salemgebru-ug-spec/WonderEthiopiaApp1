...
import ExpansionChat from "./ExpansionChat";
import { useEffect } from "react";

interface ExpansionChatDrawerProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function ExpansionChatDrawer({ isOpen, onClose, notificationId, businessName, currentRole, initialDiscussion }: ExpansionChatDrawerProps) {
